...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, colorClass, iconColorClass }) => (
  <div className="glass-card p-8 rounded-thick hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl hover:border-primary/20 group h-full flex flex-col">
    ...
    <h3 className="text-xl font-black mb-3 text-slate-800 dark:text-slate-100 group-hover:text-primary transition-colors">{title}</h3>
...
export const Features: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      iconColorClass: 'text-lavender-accent dark:text-purple-400'
    },
    {
      icon: 'account_tree',
      title: '多校区自由配置',
    ...
    },
    {
      ...
      colorClass: 'bg-slate-200 dark:bg-slate-700/40',
    ...
    <section className="py-32 relative bg-transparent" id="features">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 transition-colors">功能特性</h2>
          <p className="text-slate-500 dark:text-slate-400 font-medium text-lg transition-colors">全方位技术支撑，重新定义图书馆抢座效率</p>
        </div>
