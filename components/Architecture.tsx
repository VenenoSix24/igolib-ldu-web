    ...
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-primary px-4 py-1.5 rounded-full">
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                <h4 className="font-bold text-slate-800">Tauri 2.0 核心</h4>
                <p className="text-sm text-slate-500 mt-1">src-tauri 原生配置与权限定义，构建安全轻量的应用底座。</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                <h4 className="font-bold text-slate-800">TypeScript 业务重构</h4>
                <p className="text-sm text-slate-500 mt-1">从 LibraryService 到 WebSocketService，全链路类型安全。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden transform group-hover:-translate-y-1 transition-transform duration-500">
            {/* IDE Header */}
            ...
            <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto bg-white">
              <div className="flex flex-col gap-1 select-none">
                ...
                <div className="flex items-center gap-2 text-slate-500 mb-1">
                  ...
                  <span className="font-bold text-slate-700">seat-grabber-v2</span>
                </div>
                
                <div className="flex flex-col gap-1 border-l border-slate-100 ml-2 pl-3">
                  ...
                  <div className="flex items-center gap-2 text-slate-600 py-1">
                    ...
                    <span className="text-xs text-slate-300 ml-auto italic pr-4 hidden sm:inline">Permissions</span>
                  </div>
                  ...
                  <div className="flex flex-col gap-1 border-l border-slate-100 ml-2 pl-3">
                       ...
                       {/* services files */}
                       <div className="flex flex-col gap-0.5 border-l border-slate-100 ml-2 pl-3 mb-1">
                          <div className="flex items-center gap-2 text-slate-500 bg-blue-50/50 rounded px-2 py-1 border border-blue-100/50">
                             <Icon name="description" size="sm" className="text-blue-500" />
                             <span className="text-slate-700">LibraryService.ts</span>
                             <span className="text-[10px] text-blue-400 ml-auto">GraphQL</span>
                          </div>
                          <div className="flex items-center gap-2 text-slate-500 hover:bg-slate-50 rounded px-2 py-1">
                             <Icon name="description" size="sm" className="text-blue-500" />
                             <span>SchedulerService.ts</span>
                             <span className="text-[10px] text-slate-300 ml-auto">Core</span>
                          </div>
                          <div className="flex items-center gap-2 text-slate-500 hover:bg-slate-50 rounded px-2 py-1">
                             <Icon name="description" size="sm" className="text-blue-500" />
                             <span>WebSocketService.ts</span>
                             <span className="text-[10px] text-slate-300 ml-auto">Socket</span>
                          </div>
                       </div>
                       ...
                       <div className="flex items-center gap-2 text-slate-600 py-1">
                          ...
                          <span>pages</span>
                          <span className="text-xs text-slate-300 ml-auto pr-4 hidden sm:inline">Dashboard</span>
                       </div>
